 ...
 * ```javascript
 *
 * var uri = new URI('bitcoinprivate:b1RXUJgnuxtzHyJ5UTWerh4pNBWcVikESZe?amount=1.2');
 ...
 * ```javascript
 *
 * var valid = URI.isValid('bitcoinprivate:b1RXUJgnuxtzHyJ5UTWerh4pNBWcVikESZe');
 * // true
 * ```
 *
 * @param {string|Object} data - A bitcoin URI string or an Object
 ...
 *
 * @returns {string} BTCP URI string
 */
