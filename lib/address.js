...
Address._classifyFromVersion = function(buffer) {
  ...
  var pubkeyhashNetwork = Networks.get(buffer, 'pubkeyhash');
  var scripthashNetwork = Networks.get(buffer, 'scripthash');
...
Address.prototype.toBuffer = function() {
  //BTCP (2 bytes)
  var version = Buffer.from(this.network[this.type].toString(16), 'hex');
  //Original - BTC (1 byte)
